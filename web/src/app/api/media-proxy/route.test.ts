...
describe("media proxy", () => {
    ...
    it("rejects multiple ranges and probes before forwarding a bounded open range", async () => {
        const fetchMock = vi
    ...
    it("uses detected MIME and private caching for authenticated media", async () => {
