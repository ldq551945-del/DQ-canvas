...
type DramaStore = {
    ...
    updateEpisode: (projectId: string, episodeId: string, patch: Partial<Pick<DramaEpisode, "title" | "script" | "outline" | "hook" | "nextPreview" | "sourceRange" | "reviewStatus" | "renderTask" | "visualReview">>) => void;
