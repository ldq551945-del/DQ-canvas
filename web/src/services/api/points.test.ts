...
const user = (pointsBalance: number): LocalUser => ({ id: "user-1", accountId: "0001", username: "tester", displayName: "测试用户", bio: "", role: "user", status: "active", planId: "free", planName: "免费版", pointsBalance });
