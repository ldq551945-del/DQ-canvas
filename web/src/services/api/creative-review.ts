...
export async function reviewWorkbenchCreativeOutput(input: { recordId: string; workspace: "image" | "video"; foundation: CreativeFoundation; deliverables: CreativeDeliverableSummary[]; assets: Array<{ id: string; url: string }> }) {
