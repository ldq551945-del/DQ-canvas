                    ...
                    <>
                        <div className="grid gap-5 md:grid-cols-[300px_minmax(0,1fr)]">
                            <div className="space-y-3">
                                {prompt.coverUrl ? (
                                    <img src={imagePreviewUrl(prompt.coverUrl, 960)} alt={prompt.title} className="aspect-[4/3] w-full rounded-lg object-cover" loading="lazy" referrerPolicy="no-referrer" />
                                ) : (
