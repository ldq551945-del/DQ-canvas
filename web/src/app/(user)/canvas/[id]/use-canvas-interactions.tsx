...
import { useCanvasPointerInteractions } from "./use-canvas-pointer-interactions";
...
export function useCanvasInteractions({ state }: { state: CanvasPageState }) {
    ...
    const pointer = useCanvasPointerInteractions({ state, core });
    return { ...core, ...nodeActions, ...navigation, ...pointer };
}
